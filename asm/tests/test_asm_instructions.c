...
Test(asm, error_unknown_instruction)
{
    int size = 0;
    char *buffer = NULL;
    line_t *lines[] = {
        ...
        PTR_FIELD(line_t, "test.s", 4, "andddd r1 ,%0, r1"),
...
Test(asm, error_instruction_invalid_nb_args)
{
    int size = 0;
    char *buffer = NULL;
    line_t *lines[] = {
        PTR_FIELD(line_t, "test.s", 1, ".name \"Zork\""),
        PTR_FIELD(line_t, "test.s", 2, ".comment \"Nothing\""),
        PTR_FIELD(line_t, "test.s", 3, "sti r1,%:live,%1,5,r12"),
...
Test(asm, error_instruction_invalid_parameter_type)
{
    int size = 0;
    char *buffer = NULL;
    line_t *lines[] = {
