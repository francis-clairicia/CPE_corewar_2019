...
Test(asm, error_label_invalid_characters)
{
    int size = 0;
    char *buffer = NULL;
    line_t *lines[] = {
...
Test(asm, error_label_char_without_name)
{
    int size = 0;
    char *buffer = NULL;
    line_t *lines[] = {
        ...
        PTR_FIELD(line_t, "test.s", 3, "sti r1,%:live,%1"),
        PTR_FIELD(line_t, "test.s", 4, "and r1 ,%0, r1"),
        PTR_FIELD(line_t, "test.s", 5, ": live %1"),
        PTR_FIELD(line_t, "test.s", 6, "zjmp %:live"),
        NULL
    };
...
Test(asm, error_undefined_label_as_argument)
{
    int size = 0;
    char *buffer = NULL;
    line_t *lines[] = {
